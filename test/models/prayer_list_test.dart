...
void main() {
  group('PrayerList Model', () {
    test('should have default updatedAt and deletedAt is null', () {
      ...
      expect(list.updatedAt.isBefore(DateTime.now().add(const Duration(seconds: 1))), isTrue);
    ...
    test('should serialize and deserialize correctly', () {
      ...
      expect(map['deletedAt'], now.add(const Duration(hours: 1)).toIso8601String());
    ...
    test('should use DateTime.now() if updatedAt is missing in fromMap (legacy)', () {
      final map = {
        'id': '1',
        'name': 'Legacy List',
      };

...
void main() {
  group('PrayerRequest', () {
    test('status helper methods work', () {
      ...
      expect(PrayerRequestStatusX.fromStorage('pending'), PrayerRequestStatus.pending);
      expect(PrayerRequestStatusX.fromStorage('unknown'), PrayerRequestStatus.pending);
    });
